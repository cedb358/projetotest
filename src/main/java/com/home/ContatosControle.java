...
static {
	...
	LISTA_CONTATOS.add(new Contato("1", "Maersk", "Vazio", "GOOD7777777", "Importe", "20", null));
	LISTA_CONTATOS.add(new Contato("2", "Pacific", "Cheio", "PPLL1111111", "Exporte", "20", null));
	LISTA_CONTATOS.add(new Contato("3", "Evergreen", "Cheio", "LLPP1234567", "Exporte", "40", null));
	LISTA_CONTATOS.add(new Contato("4", "MSC", "Vazio", "GRAN7654321", "Importe", "40", null));
